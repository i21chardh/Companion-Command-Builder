...
The patch in this directory applies to `waves-lv1` 1.1.0 and adds:
...
1. Clone `https://github.com/bitfocus/companion-module-waves-lv1` at version
   `1.1.0`.
2. Apply `waves-lv1-1.1.1-relative-encoders.patch`.
3. Install dependencies and run the module compiler and
   `companion-module-check`.
4. Load the resulting `waves-lv1-1.1.1.tgz` into Companion.
