...
builder_dmg="$builder_dist/Companion-Command-Builder-0.20.84-Beta-1-arm64.dmg"
builder_zip="$builder_dist/OPEN-THIS-Companion-Command-Builder-0.20.84-Beta-1.zip"
