...
createServer(async (request, response) => {
  ...
  writeSystemLog('info', 'server-started', { builderVersion: '0.20.61-beta.1+165', companionTarget: config.companion.version, port, platform: process.platform, node: process.version }).catch(() => {});
});
