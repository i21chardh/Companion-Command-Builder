...
createServer(async (request, response) => {
  ...
  writeSystemLog('info', 'server-started', { builderVersion: '0.20.57-beta.1+161', companionTarget: config.companion.version, port, platform: process.platform, node: process.version }).catch(() => {});
});
