...
export const LIVE_WORKFLOWS = [
  ...
  { id: 'multi-ccb-surface-custody', category: 'devices', severity: 'critical', steps: 'Run CCB on the central Companion computer and a remote Satellite computer, both targeting the central Companion. Verify both instances show the combined announced surface inventory. Select a surface in CCB A and verify CCB B shows it disabled with “In use by” and the owner name. Uncheck it in A and verify B can acquire it within one refresh. Close A without releasing and verify its lease expires, while no button or Companion layout is changed.' },
